...
const TITLE = 'Не нашли информации о возврате товара';
...
export const returnPolicyMissingRule: Rule = {
  ...
  evaluate(evidence: ScanEvidence): Finding | null {
    ...
    const explanation =
      'Похоже, у вас интернет-магазин. При покупках в интернете у покупателя обычно ' +
      'есть право вернуть товар в течение 14 дней без объяснения причин. Об этом праве ' +
      'нужно рассказать на сайте: как и в какой срок вернуть товар. Мы не нашли такой ' +
      'информации на доступных нам страницах.';
    ...
    const remediation = [
      'Добавьте страницу «Возврат товара» или «Право отказа» и дайте на неё ссылку.',
      'Опишите срок возврата (обычно 14 дней) и порядок: как оформить и куда отправить товар.',
      'Укажите, кто оплачивает обратную доставку и в какой срок вернутся деньги.',
    ];
