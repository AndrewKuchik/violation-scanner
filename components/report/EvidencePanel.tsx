...
const KEY_LABELS: Record<string, string> = {
  ...
  timestamp: 'Момент (мс)',
  // Ключи новых правил (реквизиты, право отказа, доступность, GDPR, цены, ODR, axe).
  companyName: 'Название компании',
  registrationNumber: 'Рег. номер',
  vatNumber: 'Номер НДС',
  address: 'Адрес',
  email: 'E-mail',
  returnPolicy: 'Возврат/право отказа',
  mentions14Days: 'Упоминание 14 дней',
  note: 'Примечание',
  htmlLang: 'Язык страницы (lang)',
  hasLanguageSwitcher: 'Переключатель языков',
  statementLink: 'Заявление о доступности',
  statementHref: 'Ссылка',
  controllerIdentity: 'Контролёр данных',
  legalBasis: 'Правовое основание',
  dataSubjectRights: 'Права пользователя',
  contactInfo: 'Контакт по данным',
  pricesVisible: 'Видны цены',
  priceTaxWording: 'Указан налог у цены',
  staleOdrHref: 'Ссылка ODR',
  imagesMissingAlt: 'Картинок без alt',
  imagesTotal: 'Всего картинок',
  impact: 'Серьёзность',
  help: 'Проблема',
  nodes: 'Элементов',
};
