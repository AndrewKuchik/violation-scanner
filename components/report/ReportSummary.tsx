...
const CHECKLIST: string[] = [
  ...
  'Реквизиты компании (для коммерческих сайтов)',
  'Актуальность ссылки на разрешение споров (ODR)',
  'Заявление о доступности (EAA)',
  'Доступность латышской версии',
  'Право на возврат и условия (для магазинов)',
  'Прозрачность цены с налогом (для магазинов)',
  'Содержание политики конфиденциальности (контролёр, основание, права)',
  'Реальная доступность: контраст, alt, метки форм (axe)',
];
...
export function ReportSummary({
  ...
  return (
    <section className="space-y-5 rounded-xl border border-zinc-200 bg-white p-5 shadow-sm dark:border-zinc-800 dark:bg-zinc-900">
      ...
      {/* Честная сноска: часть находок вне денежной оценки GDPR. */}
      <div className="rounded-lg border border-slate-200 bg-slate-50 p-3 dark:border-slate-700 dark:bg-slate-800/40">
        <p className="text-xs leading-relaxed text-slate-600 dark:text-slate-400">
          Часть находок — вне денежной оценки GDPR (например требования к реквизитам,
          доступности, языку): по ним показан регуляторный риск, а не сумма. Их
          контролирует не Datu valsts inspekcija, а другие органы (например PTAC).
        </p>
      </div>
